...
This project is indexed by GitNexus as **DistTaskQueue** (1831 symbols, 4527 relationships, 85 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/DistTaskQueue/context` | Codebase overview, check index freshness |
| `gitnexus://repo/DistTaskQueue/clusters` | All functional areas |
| `gitnexus://repo/DistTaskQueue/processes` | All execution flows |
| `gitnexus://repo/DistTaskQueue/process/{name}` | Step-by-step execution trace |
